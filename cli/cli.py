...
@click.argument('vout')
@click.pass_obj
def sign_tx(obj, transaction, fingerprints, paths, scriptpubkeys, vout):
    ...
    signed_tx = ssm.sign_tx(obj.chain, transaction, fingerprints, paths, scriptpubkeys, vout)
